...
function ListTaskTailwindCSS() {
  ...
  return (
    <div className="min-h-screen bg-[#EBF4F6] text-[#071952]">
        ...
        {/* Hero Section */}
        <section className="py-12 px-6 bg-gradient-to-r from-[#071952] to-[#088395] text-white">
            <div className="max-w-6xl mx-auto">
                ...
                <h1 className="text-4xl md:text-6xl hidden md:flex font-bold text-left mb-4">Gestor de Tareas</h1>
